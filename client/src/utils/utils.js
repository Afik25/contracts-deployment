...
export const validationSchemaRole = Yup.object().shape({
  title: Yup.string().required("The role's title is required"),
});
...
export const validationSchemaUser = Yup.object().shape({
  sys_role: Yup.string().required("System role is required"),
  prename: Yup.string()
    .required("Firstname is required")
    .min(2, "The firstname must have at least 2 caractors"),
  name: Yup.string()
    .required("Lastname is required")
    .min(2, "The lastname must have at least 2 caractors"),
  gender: Yup.string().required("Gender is required"),
  telephone: Yup.string().required("Telephone is required"),
  mail: Yup.string().required("E-mail address is required"),
  birth: Yup.string().required("Date of birth is required"),
  birth_location: Yup.string().required("Location of birth is required"),
});
