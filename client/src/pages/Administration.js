    ...
    1: (
      <>
        <p className="title t-2">
          A code of confirmation has been sent by e-mail.
        </p>
        <div className="width">
          <div className="input-div">
            <input
                    ...
                    <img
                      src={
                        !connectedUser?.userInfo?.thumbnails
                          ? process.env.PUBLIC_URL + "/user.png"
                          : `${process.env.REACT_APP_SERVER_IP_ADDRESS}:${process.env.REACT_APP_SERVER_PORT}/${connectedUser?.userInfo?.thumbnails}`
                      }
                      alt="user-profile"
